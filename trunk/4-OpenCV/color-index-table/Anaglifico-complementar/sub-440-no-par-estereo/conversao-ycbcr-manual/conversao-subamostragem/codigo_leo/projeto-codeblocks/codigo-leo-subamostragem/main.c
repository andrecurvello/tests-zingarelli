  ...
  if(BmpOpen(argv[1]))
	...
	if(BmpTester())
	{
		...
		for(j = 0; j < file_in.nj * tjan; j++)
			for(i = 0; i < file_in.ni * tjan; i++)
			{
			    printf("%f %f %f\n",file_in.R[j][i],file_in.G[j][i],file_in.B[j][i]);
			}
		printf("YCbCr calculado - antes da subamostragem\n");
		for(j = 0; j < file_in.nj * tjan; j++)
			for(i = 0; i < file_in.ni * tjan; i++)
			{
			    printf("%f %f %f\n",file_in.Y[j][i],file_in.U[j][i],file_in.V[j][i]);
			}
		...
		//impressão de valores para verificar os resultados após conversão/subamostragem
		printf("RGB Convertido\n");
		for(j = 0; j < file_in.nj * tjan; j++)
			for(i = 0; i < file_in.ni * tjan; i++)
			{
			    printf("%f %f %f\n",file_out.R[j][i],file_out.G[j][i],file_out.B[j][i]);
			}
		printf("YCbCr calculado - após subamostragem\n");
		for(j = 0; j < file_in.nj * tjan; j++)
			for(i = 0; i < file_in.ni * tjan; i++)
			{
			    printf("%f %f %f\n",file_out.Y[j][i],file_out.U[j][i],file_out.V[j][i]);
			}
